...
サンプルは [terraform/terraform.tfvars_sample](../../terraform/terraform.tfvars_sample)。値の取得手順は [docs/manual/01-prerequisites.md](../manual/01-prerequisites.md) にある。
...
生成元: [terraform/templates/mc-server.env.tftpl](../../terraform/templates/mc-server.env.tftpl) / サンプル: [env/mc-server.env_sample](../../env/mc-server.env_sample)
...
生成元: [terraform/templates/mc-monitor.env.tftpl](../../terraform/templates/mc-monitor.env.tftpl) / サンプル: [env/mc-monitor.env_sample](../../env/mc-monitor.env_sample)
...
生成元: [terraform/templates/rclone.conf.tftpl](../../terraform/templates/rclone.conf.tftpl) / サンプル: [env/rclone.conf_sample](../../env/rclone.conf_sample)
...
| 値 | 場所 | 変数化していない理由 |
| --- | --- | --- |
| Terraform のバージョン `1.16.3` | `terraform/.terraform-version` | tenv が読む固定ファイル。変数ではない ([A2. ツール導入](A2-toolchain.md)) |
...
| `VERSION=LATEST` | compose テンプレート | 固定したい場合は [07-tech-stack.md](07-tech-stack.md) 参照 |
