<!-- このページは docs/spec/A2-toolchain.md から生成しています。直接編集しないでください。
...
対話で聞かれる項目と取得場所は [docs/manual/01-prerequisites.md](../blob/main/docs/manual/01-prerequisites.md) にある。
...
詳細は [ansible/README.md](../blob/main/ansible/README.md)。
...
検証項目は [09. 検証方法](Spec-09-verification) にある。
