<!-- このページは docs/spec/00-introduction.md から生成しています。直接編集しないでください。
...
| バックアップの自動化 | 手動実行を前提とする ([05. バックアップ](Spec-05-backup) 参照) |
...
| 単一の正を1箇所に置く | 同じ設定を2箇所で管理しない ([02. アーキテクチャ](Spec-02-architecture) 参照) |
...
| 文書 | 内容 |
| --- | --- |
| [docs/manual/](../blob/main/docs/manual) | 構築手順書 (原本) |
| [todo.md](../blob/main/todo.md) | 検討中の項目 |
